...
{
	public partial class GameSessionFactory : ModelFactory<IGameSession, GameSessionModel, UnityEngine.Vector3Int, System.Int32>
	{
...
namespace pindwin.Scripts.GameSession.Generated
{
	public class GameSessionInstallerBase : Installer<GameSessionInstallerBase>
	{
		...
		{
			Container.BindFactory<Id, UnityEngine.Vector3Int, System.Int32, GameSessionModel, GameSessionFactory>();
			Container.Bind<IModelFactory<IGameSession, UnityEngine.Vector3Int, System.Int32>>().To<GameSessionFactory>().FromResolve();
